...
//--------------------------------------------------------------------------
  BitVector::Iterator*  DeltaVector::newIterator(char *placement)
  {
      return new ((DeltaVector::Iterator*)placement) DeltaVector::Iterator(*this);
  }
    size_t DeltaVector::iterSize()
    {
